...
def voxelGrid_filter(PC, num_requested_samples, mode):
    ...
    :param mode: list of strings, can contain any of the following:
                 ...
                 "equal_nbins_per_axis" - same number of bins for each axis (x,y,z).
                 Otherwise the bins are cube shaped, and usually a different number of bins fits in each of the dimensions.
