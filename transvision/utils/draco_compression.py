...
def save_ply(path, batch_coords, batch_features):
    # path = "/media/hdd/yuan/transvision/transvision/logs/fpvrcnn_intermediate_fusion/cpms/"
...
if __name__ == "__main__":
    cpm_sizes = cal_avg_num_kpts("/media/hdd/yuan/transvision/transvision/logs/fpvrcnn_intermediate_fusion/cpms")
    # cpm_sizes = draco_compression("/media/hdd/yuan/transvision/transvision/logs/fpvrcnn_intermediate_fusion/cpms")
