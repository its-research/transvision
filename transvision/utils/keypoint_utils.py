...
from transvision.utils.subsampling_utils import get_random_subset
...
def mask_points_by_range(points, limit_range, return_mask=False):
    if len(limit_range) == 6:
        ...
        mask = (points[:, 0] > limit_range[0]) & (points[:, 0] < limit_range[2]) & (points[:, 1] > limit_range[1]) & (points[:, 1] < limit_range[3])
...
def seq_generate():
    dirs = ["/GPFS/rhome/yifanlu/workspace/dataset/OPV2V/train", "/GPFS/rhome/yifanlu/workspace/dataset/OPV2V/validate" "/GPFS/rhome/yifanlu/workspace/dataset/OPV2V/test"]
...
if __name__ == "__main__":
    ...
    scenario_folders = ["/GPFS/rhome/yifanlu/workspace/transvision/dataset_link/validate/2021_08_21_17_30_41"]
