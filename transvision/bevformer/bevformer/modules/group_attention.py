...
class GroupMultiheadAttention(BaseModule):
    ...
    def __init__(self, embed_dims, num_heads, attn_drop=0., proj_drop=0., group=1, dropout_layer=dict(type='Dropout', drop_prob=0.), init_cfg=None, batch_first=False, **kwargs):
