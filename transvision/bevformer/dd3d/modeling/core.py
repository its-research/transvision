...
from transvision.bevformer.dd3d.utils.tensor2d import compute_features_locations as compute_locations_per_level
...
class DD3D(nn.Module):
    ...
    def __init__(self,
        ...
        self.prepare_targets = DD3DTargetPreparer(num_classes=num_classes, input_shape=self.backbone_output_shape, box3d_on=box3d_on, **target_assign_cfg)
    ...
    def compute_locations(self, features):
        ...
        for level, feature in enumerate(features):
            h, w = feature.size()[-2:]
            locations_per_level = compute_locations_per_level(h, w, in_strides[level], feature.dtype, feature.device, offset=self.feature_locations_offset)
