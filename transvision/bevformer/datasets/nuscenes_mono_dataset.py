...
class CustomNuScenesMonoDataset(CocoDataset):
    ...
    def get_attr_name(self, attr_idx, label_name):
        ...
        AttrMapping_rev2 = [
            'cycle.with_rider', 'cycle.without_rider', 'pedestrian.moving', 'pedestrian.standing', 'pedestrian.sitting_lying_down', 'vehicle.moving', 'vehicle.parked',
    ...
    def _get_pipeline(self, pipeline):
        ...
        if pipeline is None:
            if not hasattr(self, 'pipeline') or self.pipeline is None:
                warnings.warn('Use default pipeline for data loading, this may cause '
