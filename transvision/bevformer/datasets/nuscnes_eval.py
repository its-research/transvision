...
from nuscenes.eval.detection.constants import PRETTY_DETECTION_NAMES, PRETTY_TP_METRICS, TP_METRICS, TP_METRICS_UNITS
...
# from transvision.bevformer.models.utils.visual import save_tensor
...
if __name__ == '__main__':
    ...
    parser.add_argument(
        '--config_path', type=str, default='', help='Path to the configuration file.'
