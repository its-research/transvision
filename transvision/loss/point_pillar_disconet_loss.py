...
class PointPillarDiscoNetLoss(nn.Module):
    ...
    def forward(self, output_dict, target_dict, prefix=""):
        ...
        if "teacher_rm{}".format(prefix) in output_dict:
            ...
            teacher_psm = output_dict["teacher_psm"]
        ...
        self.loss_dict.update({"total_loss{}".format(prefix): total_loss, "reg_loss{}".format(prefix): reg_loss, "conf_loss{}".format(prefix): conf_loss})
