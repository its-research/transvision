...
from transvision.utils import box_utils, common_utils
...
class BasePostprocessor(object):
    ...
    def generate_object_center_v2x(self, cav_contents, reference_lidar_pose):
        ...
        object_ids : list
            Length is number of bbx in current sample.
        """
        # from transvision.data_utils.datasets import GT_RANGE
        ...
        box_utils.project_world_objects_v2x(tmp_object_dict, output_dict, reference_lidar_pose, filter_range, self.params["order"], lidar_np=lidar_np)
