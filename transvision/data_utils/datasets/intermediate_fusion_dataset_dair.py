...
import transvision.data_utils.post_processor as post_processor
import transvision.utils.pcd_utils as pcd_utils
from transvision.data_utils.augmentor.data_augmentor import DataAugmentor
from transvision.data_utils.pre_processor import build_preprocessor
from transvision.utils import box_utils
from transvision.utils.pcd_utils import downsample_lidar_minimum, mask_ego_points, mask_points_by_range, shuffle_points
from transvision.utils.pose_utils import add_noise_data_dict
from transvision.utils.transformation_utils import (
...
class IntermediateFusionDatasetDAIR(Dataset):
    ...
    def generate_object_center(self, cav_contents, reference_lidar_pose, return_visible_mask=False):
        ...
        return self.post_processor.generate_object_center_dairv2x(cav_contents, reference_lidar_pose, return_visible_mask)
    ...
    def get_item_single_car(self, selected_cav_base, ego_pose, ego_pose_clean, ego_keypoints, ego_allpoints, idx):
        ...
        object_bbx_center_single, object_bbx_mask_single, object_ids_single = self.generate_object_center_single([selected_cav_base], ego_pose_clean)
    ...
    def __getitem__(self, idx):
        ...
        for cav_id in cav_id_list:
            ...
            selected_cav_processed = self.get_item_single_car(selected_cav_base, ego_lidar_pose, ego_lidar_pose_clean, ego_keypoints, ego_allpoints, idx)
    ...
    def collate_batch_train(self, batch):
        ...
        if self.visualize:
            ...
            origin_lidar_v = np.array(downsample_lidar_minimum(pcd_np_list=origin_lidar_v))
        ...
        if (
            ...
            and (output_dict["ego"]["processed_lidar"]["voxel_coords"][:, 0].max().int().item() + 1) != record_len.sum().int().item()
        ):
            return None
    ...
    def collate_batch_test(self, batch):
        ...
        output_dict["ego"].update({"sample_idx": batch[0]["ego"]["sample_idx"], "cav_id_list": batch[0]["ego"]["cav_id_list"]})
