...
from transvision.utils.common_utils import torch_tensor_to_numpy
...
def inference_late_fusion(batch_data, model, dataset):
    ...
    ----------
    batch_data : dict
    model : transvision.object
    dataset : transvision.LateFusionDataset
...
def inference_no_fusion(batch_data, model, dataset):
    ...
    pred_box_tensor, pred_score, gt_box_tensor = dataset.post_process_no_fusion(batch_data, output_dict_ego)  # only for late fusion dataset
...
def inference_early_fusion(batch_data, model, dataset):
    ...
    batch_data : dict
    model : transvision.object
    dataset : transvision.EarlyFusionDataset
