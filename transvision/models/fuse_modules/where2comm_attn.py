...
from transvision.models.comm_modules.where2comm import Communication
from transvision.models.sub_modules.torch_transformation_utils import warp_affine_simple
            ...
            for idx in range(self.num_levels):
                if self.agg_mode == "ATTEN":
                    ...
                    fuse_network = TransformerFusion(
                        channels=num_filters[idx], n_head=args["agg_operator"]["n_head"], with_spe=args["agg_operator"]["with_spe"], with_scm=args["agg_operator"]["with_scm"]
                    )
