...
class SpatialCrossAttentionPts(BaseModule):
    ...
    def __init__(self, embed_dims=256, num_cams=6, pc_range=None, dropout=0.1, init_cfg=None, batch_first=False, deformable_attention=None, **kwargs):
    ...
    def forward(self, query, key, value, residual=None, query_pos=None, spatial_shapes=None, reference_points_lidar=None, bev_mask=None, level_start_index=None, **kwargs):
        ...
        queries = self.deformable_attention(
            query=query, key=key, value=value, reference_points=reference_points_lidar, spatial_shapes=spatial_shapes, level_start_index=level_start_index)
