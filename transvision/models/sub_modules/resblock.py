...
__all__ = ["resnet18", "resnet34", "resnet50", "resnet101", "resnet152", "resnext50_32x4d", "resnext101_32x8d", "wide_resnet50_2", "wide_resnet101_2"]
...
class ResNetModified(nn.Module):
    def __init__(
        ...
        self.layer2 = self._make_layer(block, num_filters[1], layers[1], stride=layer_strides[1], dilate=replace_stride_with_dilation[0])
        self.layer3 = self._make_layer(block, num_filters[2], layers[2], stride=layer_strides[2], dilate=replace_stride_with_dilation[1])
...
def _resnet(arch: str, block: Type[Union[BasicBlock, Bottleneck]], layers: List[int], pretrained: bool, progress: bool, **kwargs: Any) -> ResNetModified:
