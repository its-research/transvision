...
class BEVFormer(MVXTwoStageDetector):
    ...
    def __init__(self,
        ...
        super(BEVFormer, self).__init__(pts_voxel_layer, pts_voxel_encoder, pts_middle_encoder, pts_fusion_layer, img_backbone, pts_backbone, img_neck, pts_neck, pts_bbox_head,
    ...
    def forward_test(self, img_metas, img=None, **kwargs):
        ...
        new_prev_bev, bbox_results = self.simple_test(img_metas[0], img[0], prev_bev=self.prev_frame_info['prev_bev'], **kwargs)
