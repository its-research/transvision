...
def parse_args():
    ...
    parser.add_argument(
        '--online', action='store_true', help='Whether to perform online visualization. Note that you often '
...
def main():
    ...
    for idx, data_info in enumerate(track_iter_progress(data_infos)):
        ...
        elif dataset_type in ['ScanNetDataset', 'SUNRGBDDataset', 'ScanNetSegDataset', 'S3DISSegDataset', 'S3DISDataset']:
        ...
        if vis_task in ['multi_modality-det', 'mono-det']:
            ...
            show_proj_bbox_img(idx, dataset, args.output_dir, file_name, show=args.online, is_nus_mono=(dataset_type == 'NuScenesMonoDataset'))
