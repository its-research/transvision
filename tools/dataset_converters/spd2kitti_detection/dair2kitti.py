...
from tools.dataset_converter.utils import pcd2bin, read_json

parser = argparse.ArgumentParser('Generate the Kitti Format Data')
parser.add_argument('--source-root', type=str, default='data/SPD/cooperative-vehicle-infrastructure/vehicle-side', help='Raw data root about SPD')
parser.add_argument(
    '--target-root', type=str, default='data/KITTI/cooperative-vehicle-infrastructure/vehicle-side', help='The data root where the data with kitti format is generated')
