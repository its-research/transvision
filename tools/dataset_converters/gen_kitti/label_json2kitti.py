...
def write_kitti_in_txt(my_json, path_txt):
    ...
    for item in my_json:
        ...
        i9, i11, i10 = str(item['3d_dimensions']['h']), str(
            item['3d_dimensions']['w']), str(item['3d_dimensions']['l'])
        i12, i13, i14 = str(item['3d_location']['x']), str(
            item['3d_location']['y']), str(item['3d_location']['z'])
