...
parser.add_argument(
    '--target-root', type=str, default='data/KITTI-Track/cooperative-vehicle-infrastructure/vehicle-side', help='The data root where the data with kitti-Track format is generated')
