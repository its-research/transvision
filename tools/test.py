...
def parse_args():
    ...
    parser.add_argument("--show-dir", help="directory where painted images will be saved. " "If specified, it will be automatically saved " "to the work_dir/timestamp/show_dir")
    parser.add_argument(
        "--task", type=str, choices=["mono_det", "multi-view_det", "lidar_det", "lidar_seg", "multi-modality_det"], help="Determine the visualization method depending on the task."
    )
...
def trigger_visualization_hook(cfg, args):
    ...
    if "visualization" in default_hooks:
        ...
        raise RuntimeError("VisualizationHook must be included in default_hooks." "refer to usage " "\"visualization=dict(type='VisualizationHook')\"")
