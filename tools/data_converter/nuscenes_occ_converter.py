...
def create_nuscenes_occ_infos(root_path, occ_path, out_path, can_bus_root_path, info_prefix, version='v1.0-trainval', max_sweeps=10):
    ...
    train_nusc_infos, val_nusc_infos = _fill_occ_trainval_infos(nusc, occ_anno, token2name, nusc_can_bus, train_scenes, val_scenes, test, max_sweeps=max_sweeps)
...
def _fill_occ_trainval_infos(nusc, occ_anno, token2name, nusc_can_bus, train_scenes, val_scenes, test=False, max_sweeps=10):
