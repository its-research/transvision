#!/usr/bin/env python3
"""Verify the canonical EventTrack-V2X paper supplemental registry."""
...
from transvision.models.event_track_v2x.network_disturbance import (  # noqa: E402
    ...
    decode_condition_input_manifest_inventory_v1 as _decode_condition_input_manifest_inventory,
)
from transvision.models.event_track_v2x.supplemental_registry import (  # noqa: E402
...
def _parser() -> argparse.ArgumentParser:
    ...
    parser.add_argument(
        ...
        required=True,
        help="Expected SHA-256 of the frozen raw-sensor detection cache.",
    )
    return parser
...
def main(argv: Sequence[str] | None = None) -> int:
    ...
    registry = decode_paper_supplemental_registry(args.registry.read_bytes())
    measured_trace_receipt = decode_measured_trace_receipt(
        args.measured_trace_receipt.read_bytes()
    )
    condition_input_manifests = _decode_condition_input_manifest_inventory(
    ...
    validate_paper_supplemental_registry_v1(
        ...
        raw_sensor_detector_cache_sha256=(
            args.raw_sensor_detector_cache_sha256
        ),
