"""Support-residual single-factor candidate with student bbox loss weight 2.5."""
...
experiment = dict(
    _delete_=True,
    name="dair_improvement_support_residual_bbox25",
    stage="resilient_improvement",
    improvement=dict(
        component="student detection bbox regression loss",
        setting=(
            "support-residual base with student bbox loss weight 2.5; "
    ...
    trigger=dict(
        ...
        peer_experiment="dair_improvement_no_reliability_bbox25",
    ),
    protocol_lock=dict(
