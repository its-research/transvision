"""P5: P4 with only the student bbox loss raised to 2.5."""
...
experiment = dict(
    _delete_=True,
    name="dair_improvement_reliability_gated_residual_full_nonlinear_bbox25",
    stage="resilient_improvement",
    improvement=dict(
        component="student detection bbox regression loss",
        setting="P4 with student bbox loss 2.5; frozen teacher remains 2.0",
    ),
