"""Controlled AttFuse-style L+C fusion baseline on DAIR-V2X."""
...
experiment = dict(
    name="dair_controlled_baseline_attfuse",
    stage="controlled_baseline",
    protocol="causal multimodal cooperative detection",
    method="AttFuse-style per-BEV-position masked-attention L+C adaptation",
