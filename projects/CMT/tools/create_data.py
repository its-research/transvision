...
if __name__ == '__main__':
    ...
    if args.dataset == 'nuscenes' and args.version != 'v1.0-mini':
        ...
        nuscenes_data_prep(
            root_path=args.root_path, info_prefix=args.extra_tag, version=train_version, dataset_name='CustomNuScenesDataset', out_dir=args.out_dir, max_sweeps=args.max_sweeps)
        test_version = f'{args.version}-test'
        nuscenes_data_prep(
            root_path=args.root_path, info_prefix=args.extra_tag, version=test_version, dataset_name='CustomNuScenesDataset', out_dir=args.out_dir, max_sweeps=args.max_sweeps)
