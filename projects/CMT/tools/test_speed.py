...
class Wrapper:
    ...
    def __init__(self, cfg, checkpoint=None) -> None:
    ...
    def test_speed(self, num_iters=100, amp=False):
        data_loader = build_dataloader(self.dataset, samples_per_gpu=1, workers_per_gpu=self.cfg.data.workers_per_gpu, dist=False, shuffle=False)
...
if __name__ == '__main__':
    wrapper = Wrapper(cfg='your path to config file', )
