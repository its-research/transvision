...
from mmdet3d.core import PseudoSampler, circle_nms, draw_heatmap_gaussian, gaussian_radius, xywhr2xyxyr
from mmdet3d.models.builder import HEADS, build_loss
from mmdet3d.models.utils import FFN, PositionEmbeddingLearned, TransformerDecoderLayer
from mmdet3d.ops.iou3d.iou3d_utils import nms_gpu
from mmdet.core import AssignResult, build_assigner, build_bbox_coder, build_sampler, multi_apply
                    ...
                    for task in self.tasks:
                        ...
                        if task['radius'] > 0:
                            if self.test_cfg['nms_type'] == 'circle':
                                ...
                                task_keep_indices = torch.tensor(circle_nms(
