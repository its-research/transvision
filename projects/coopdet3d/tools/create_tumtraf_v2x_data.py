...
def tumtraf_v2x_data_prep(root_path, info_prefix, out_dir, workers, splits=['training', 'validation']):
    print('split: ', splits)
...
if __name__ == '__main__':
    tumtraf_v2x_data_prep(root_path=args.root_path, info_prefix='tumtraf_v2x_nusc', out_dir=args.out_dir, workers=args.workers, splits=args.splits.split(','))
