...
if __name__ == '__main__':
    ...
    data_infos_train_path = './DAIR-V2X/cooperative-vehicle-infrastructure/flow_data_jsons/flow_data_info_train.json'
    ...
    data_infos_flow_path = './DAIR-V2X/cooperative-vehicle-infrastructure/flow_data_jsons/flow_data_info_train_2.json'
    ...
    for async_k in range(0, 6):
        ...
        data_infos_flow_path = './DAIR-V2X/cooperative-vehicle-infrastructure/flow_data_jsons/flow_data_info_val_' + str(async_k) + '.json'
